...
- (OrderedDictionary *)sortedOrderedDictionaryUsingComparator:(NSComparator)cmptr {
    NSArray *valueArray = [_values sortedArrayUsingComparator:cmptr];
    NSMutableArray *keyArray = [[NSMutableArray alloc] init];
    for (id object in valueArray) {
        NSInteger originValue = [_values indexOfObject:object];
        [keyArray addObject:[self keyAtIndex:originValue]];
    }
    OrderedDictionary *orderedDictionary = [[OrderedDictionary alloc] initWithObjects:valueArray forKeys:keyArray];
